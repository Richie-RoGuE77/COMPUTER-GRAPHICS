/*
4 . program to draw a line using Bresenham's Line Algorithm (BLA)
for lines with slopes positive and greater than 1
*/
...
main()
{
	...
	while(run)
	{
		...
		if((( dy < dx )&& (dy < 0 && dx > 0 ) ) || ( ( dy > dx ) && (dy > 0 && dx < 0) ) )
		{
			...
			outtextxy(a.x-40,a.y+5,"(x1,y1)");
			outtextxy(a.x+5,a.y-5,") <- +ve slope");
			...
			printf("Slope is Not Positive and Not Greater than 1\n\a");
        }
